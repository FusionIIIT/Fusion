...
urlpatterns = [
    ...
    url(r'^get-booking-requests/', views.get_booking_requests,
        name='get_booking_requests'),
    url(r'^get-active-bookings/', views.get_active_bookings,
    ...
    url(r'^cancel-booking-request/', views.cancel_booking_request,
    ...
    url(r'^bill_between_date_range/',
        views.bill_between_dates, name='generate_records'),
