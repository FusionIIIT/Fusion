...
class Programme(models.Model):
    ...
    programme_begin_year = models.PositiveIntegerField(default=timezone.now, null=False)
...
class Batch(models.Model):
    ...
    # instigated_semesters = models.ManyToManyField(Semester, null=True, blank=True)
...
class CourseSlot(models.Model):
    ...
    # for_semesters = models.ManyToManyField(Semester, blank=True)
    name = models.CharField(max_length=100, null=False, blank=False)
