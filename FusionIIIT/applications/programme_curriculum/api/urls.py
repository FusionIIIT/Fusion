...
urlpatterns = [
    ...
    path('bulk_update_student_status/', views_student_management.bulk_update_student_status, name='bulk_update_student_status'),
    path('admin_bulk_update_student_status/', views_student_management.bulk_update_student_status, name='admin_bulk_update_student_status'),
