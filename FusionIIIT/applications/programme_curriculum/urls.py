...
urlpatterns = [
    ...
    path('admin_mainpage/', views.admin_main_page),
    ...
    path('admin_add_semester', views.add_semester_form, name='add_semester_form'),
    ...
    path('admin_edit_semesters/<curriculum_id>>', views.edit_semesters_form, name='edit_semesters_form'),
    path('admin_edit_courselot/<courseslot_id>', views.edit_courselot_form, name='edit_courselot_form'),
    path('admin_edit_batch/<batch_id>', views.edit_batch_form, name='edit_batch_form'),
    path('admin_edit_discipline/<batch_id>', views.edit_discipline_form, name='edit_discipline_form'),   
]