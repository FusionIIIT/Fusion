...
#     stock_entry=get_object_or_404(StockEntry,item_id=request.POST.get('id'))
#     print(stock_entry.bill,"stock_entry")
#     if(stock_entry.bill):
...
#         return response
#     else:
#         return Response({"message": "No bill attached"}, status=status.HTTP_404_NOT_FOUND)
