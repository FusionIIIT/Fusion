...
class File(models.Model):
    employee_id = models.ForeignKey(ExtraInfo, 
        on_delete=models.CASCADE, related_name='employee_id')
    ...
    substitute_id = models.ForeignKey(ExtraInfo, 
        on_delete=models.CASCADE, related_name='substitute_id')
