...
urlpatterns = [
    ...
    url(r'^deleteSenator/(?P<pk>[0-9]+)$',
        views.deleteSenator, name='deleteSenator'),
    url(r'^add_convenor/$', views.add_convenor, name='add_convenor'),
    url(r'^deleteConvenor/(?P<pk>[0-9]+)$',
        views.deleteConvenor, name='deleteConvenor'),
    ...
    url(r'^add_advanced_profile', views.add_advanced_profile,
        name='add_advanced_profile'),
    url(r'^add_grade', views.add_grade, name='add_grade'),
    url(r'^add_course', views.add_course, name='add_course'),
    url(r'^delete_advanced_profile', views.delete_advanced_profile,
        name="delete_advanced_profile"),
    ...
    url(r'^delete_exam_timetable', views.delete_exam_timetable,
    ...
    url(r'^generate_preregistration_report', views.generate_preregistration_report,
        name="generate_preregistration_report")
]
