...
urlpatterns = [
    ...
    url(r'noOfEntriesAES/$', views.noOfEntriesAES, name='No Of Entries AES'),
    ...
    url(r'noOfEntriesPreBid/$', views.noOfEntriesPreBid, name='No Of Entries Pre Bid'),
    url(r'noOfEntriesTechnicalBid/$', views.noOfEntriesTechnicalBid, name='No Of Entries Technical Bid'),
    url(r'noOfEntriesFinancialBid/$', views.noOfEntriesFinancialBid, name='No Of Entries Financial Bid'),
    ...
    url(r'noOfEntriesMilestones/$', views.noOfEntriesMilestones, name='No Of Entries Milestones'),
    url(r'page3_1/$', views.page3_1, name='IWD Page 3.1'),
    url(r'noOfEntriesExtensionOfTime/$', views.noOfEntriesExtensionOfTime, name='No Of Entries Extension Of Time'),
    ...
    url(r'extensionFormViewgit/$', views.extensionFormView, name='Extension Form'),
