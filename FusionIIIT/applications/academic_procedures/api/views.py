...
from applications.academic_procedures.views import (get_user_semester, get_acad_year,
                                                    ...
                                                    get_dropped_courses_count, get_added_course_count,
...
def academic_procedures_student(request):
    ...
    if str(des.designation) == 'student':
        ...
        add_courses_options_data = serializers.CurriculumSerializer(add_courses_options, many=True).data
        ...
        resp = {
            ...
            'add_courses_options': add_courses_options_data,
