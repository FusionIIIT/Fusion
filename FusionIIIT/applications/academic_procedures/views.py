...
def academic_procedures_student(request):
    ...
    if str(des.designation) == "student":
        ...
        # The post request here is generated by submission of branch change form present in branchChange.html
