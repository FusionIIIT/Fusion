...
class AssistantshipClaim(models.Model):
    ...
    student = models.ForeignKey(Student, on_delete=models.CASCADE)
    date = models.DateTimeField()  # do auto
    ...
    ta_supervisor = models.ForeignKey(Faculty, on_delete=models.CASCADE)
    thesis_supervisor_remark = models.BooleanField(default=False)
    thesis_supervisor = models.ForeignKey(Faculty, on_delete=models.CASCADE)
...
class MTechGraduateSeminarReport:
...
class PhDProgressExamination:
    ...
    quantity_of_work = models.CharField(max_length=15, choices=Quantity_of_work)
    Overall_grade = models.CharField(max_length=2, choices=Grade)
    completion_period = models.IntegerField(null=False)
    panel_report = models.TextField(null=False)
    continuation_enhancement_assistantship = models.CharField(max_length=20, choices=continuation_and_enhancement_choice,null=False)
    enhancement_assistantship = models.CharField(max_length=15, null=False, choices=continuation_and_enhancement_choice)
    annual_progress_seminar = models.CharField(max_length=2, null=False,)
    commments = models.TextField(null=True, choices=recommendations)
    places = models.CharField(max_length=20, null=False)