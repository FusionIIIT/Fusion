...
function request_booking (event) {
    ...
    hall_no = $('input[name="hall_number"]').val();
    console.log("hall no in  console");
    console.log(hall_no);
    booking_from = $('input[name="arrival_date"]').val();
    booking_to = $('input[name="departure_date"]').val();
    // arrival_hour = $('input[name="arrival-hour"]').val();
    // arrival_minute = $('input[name="arrival-minutes"]').val();
    arrival = $('input[name="arrival_time"]').val();
    // departure_hour = $('input[name="departure-hour"]').val();
    // departure_minute = $('input[name="departure-minutes"]').val();
    departure = $('input[name="departure_time"]').val();
    ...
    booking_from_time = arrival;
    booking_to_time = departure;
...
// visitor details
    ...
    $.ajax({
        type: 'POST',
        url: '/hostelmanagement/request_booking/',
        data: {
                'hall_no': hall_no,
               'intender' : intender,
            //    'category' : category,
        ...
        success: function(data,err) {
            console.log(name + " " + phone + " " + email + " " + address + " " +nationality);
