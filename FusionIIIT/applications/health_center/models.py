...
class Complaint(models.Model):
    ...
    feedback = models.CharField(max_length=100, null=False, blank=False)                          #This is the feedback given by the compounder
    complaint = models.CharField(max_length=100, null=False, blank=False)                         #Here Complaint given by user cannot be NULL!
