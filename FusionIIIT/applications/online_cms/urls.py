...
urlpatterns = [
    ...
    url(r'^(?P<course_code>[A-z]+[0-9]+)/add_video$', views.add_videos,
        name='add_videos'),
    url(r'^(?P<course_code>[A-z]+[0-9]+)/delete/$', views.delete,
        name='delete'),
    ...
    url(r'^(?P<course_code>[A-z]+[0-9]+)/edit_quiz/(?P<quiz_code>[0-9]+)/(?P<topic_id>[0-9]+)$',
        views.edit_quiz_topic, name='edit_quiz_topic'),
    url(r'^(?P<course_code>[A-z]+[0-9]+)/(?P<quiz_id>[0-9]+)/add_question_topic$',
        views.add_question_topicwise, name='add_question_topicwise'),
    url(r'^(?P<course_code>[A-z]+[0-9]+)/(?P<quiz_id>[0-9]+)/add_questions_to_quiz$',
        views.add_questions_to_quiz, name='add_questions_to_quiz'),
    url(
        r'^(?P<course_code>[A-z]+[0-9]+)/(?P<quiz_code>[0-9]+)/(?P<topic_id>[0-9]+)/remove_quiz_question$',
    ...
    url(r'^(?P<course_code>[A-z]+[0-9]+)/create_bank$', views.create_bank,
        name='create_bank'),
    url(r'^(?P<course_code>[A-z]+[0-9]+)/(?P<qb_code>[0-9]+)/(?P<topic_id>[0-9]+)$',
        views.edit_qb_topics, name='edit_qb_topics'),
    url(r'^(?P<course_code>[A-z]+[0-9]+)/(?P<qb_code>[0-9]+)/(?P<topic_id>[0-9]+)/add_question$',
        views.add_question, name='add_question'),
    url(r'^(?P<course_code>[A-z]+[0-9]+)/(?P<qb_code>[0-9]+)/(?P<topic_id>[0-9]+)/remove_question$',
        views.remove_question, name='remove_question'),
    url(r'^(?P<course_code>[A-z]+[0-9]+)/edit_bank/(?P<qb_code>[0-9]+)$',
