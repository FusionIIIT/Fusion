...
class Mcm(models.Model):
    ...
    father_occ = models.CharField(
        max_length=10, choices=Constants.FATHER_OCC_CHOICE, default=""
    )
    mother_occ = models.CharField(
        max_length=10, choices=Constants.MOTHER_OCC_CHOICES, default=""
    )
    ...
    student = models.ForeignKey(
        Student, on_delete=models.CASCADE, related_name="mcm_info"
    )
...
class IIITDM_Proficiency(models.Model):
    ...
    research_Or_Patent_doc = models.FileField(null=True, blank=True)
    ...
    nc = models.TextField(max_length=1000, null=True)  # new attribute added for PG
    nc_doc = models.FileField(null=True, blank=True)  # new attribute added for PG
    indian_Conference = models.TextField(max_length=1000, null=True)
    indian_Conference_doc = models.FileField(null=True, blank=True)
    national_Conference = models.TextField(max_length=1000, null=True)
    national_Conference_doc = models.FileField(null=True, blank=True)
