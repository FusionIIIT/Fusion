...
urlpatterns = [
    ...
    url(r'^(?P<ap_id>[0-9]+)/processvacafood/',
        views.processvacafood, name='processvacafood'),
    ...
    url(r'^(?P<ap_id>[0-9]+)/responserebate/',
        views.responserebate, name='responserebate'),
    url(r'^(?P<ap_id>[0-9]+)/responsespl/',
        views.responsespl, name='responsespl'),
