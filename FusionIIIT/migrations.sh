...
python3 manage.py migrate leave
python3 manage.py makemigrations eis
python3 manage.py migrate eis
python3 manage.py makemigrations academic_information
python3 manage.py migrate academic_information
python3 manage.py makemigrations academic_procedures
python3 manage.py migrate academic_procedures
