# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2019-02-15 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='holds_designations', related_query_name='check', to=settings.AUTH_USER_MODEL)),
